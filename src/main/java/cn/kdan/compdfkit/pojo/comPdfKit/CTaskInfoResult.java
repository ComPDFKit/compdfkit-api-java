...
public class CTaskInfoResult {
     ...
     * fileInfoDTOList
     */
    private List<CFileInfo> CFileInfoList;
    ...
    public List<CFileInfo> getFileInfoDTOList() {
        return CFileInfoList;
    }

    public void setFileInfoDTOList(List<CFileInfo> CFileInfoList) {
        this.CFileInfoList = CFileInfoList;
    }
    ...
    public String toString() {
        return "QueryTaskInfoResult{" +
                ...
                ", fileInfoList=" + CFileInfoList.toString() +
                '}';
    }
}
